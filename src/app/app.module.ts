...
@NgModule({
  declarations: [AppComponent, ProductComponent, ProductFormComponent, ProductAddComponent, ProductEditComponent, ProductsComponent, ProductsTableComponent, TableGenericComponent, ProductsListComponent],
  imports: [
    BrowserModule,
    AppRoutingModule,
